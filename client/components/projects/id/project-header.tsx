...
export const ProjectHeader = ({ id }: ProjectHeadingProps) => {
  ...
  return (
    <>
      <div className="flex flex-wrap items-end justify-between gap-x-8 gap-y-2 border-2 border-x-0 border-t-0 border-muted pb-1 sm:gap-y-0 md:flex-nowrap">
        <h1 className="flex max-w-4xl flex-wrap items-end">
          <span className="text-3xl font-extrabold leading-tight tracking-tighter sm:text-3xl md:text-5xl lg:text-6xl">
            {project.name}
          </span>
          <Link
            className="text-md ml-2 hidden pt-2 text-muted-foreground hover:underline sm:text-lg md:block md:text-xl lg:text-2xl"
